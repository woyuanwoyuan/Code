...
var form = document.MissionForm1; 
...
<div class="firstdiv">
  <span class="firstspan">实验说明:
			用户自行设计跟踪算法，利用平台的视频库，研究用户算法的有效性 </span>
  </div>	
<form   name="MissionForm1" method="post" enctype="multipart/form-data" action="">
<table width="98%" border="0" cellpadding="1" cellspacing="1" align="center"  class="contTable">
		...
		<tr>
			<td>
				<table width="100%"  border="0" cellspacing="0" cellpadding="0" class="contTable"  align="center">
					<tr bgcolor="#00f">
						<td  style="color:#000;text-indent:12px;line-height:30px;font-weight:bold;"><span id="Label1">视频选择</span> <span id="Label10" style="color:Red;">*</span></td>
						</tr>
						<tr>
	...
	<tr>
		    <td>
		<input type="button" name="btnOk1" value="跟踪实验" id="btnOk1" onclick="manySend('UploadServlet?flag=3&testmethod=3&testType=normaltrack')" style="width: 89px; height: 31px" />&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="button" name="btnOk2" value="对比实验" id="btnOk2" onclick="manySend('UploadServlet?flag=3&testmethod=3&testType=comparetrack')" style="width: 89px; height: 31px" />
