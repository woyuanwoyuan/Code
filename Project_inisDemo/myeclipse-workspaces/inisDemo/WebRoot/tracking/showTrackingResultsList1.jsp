...
<link rel="stylesheet" type="text/css" href="admin/css/base.css" >
  ...
  <body>
  <form name="compare1" method="post"  action="CompareServlet?flag=2">
  <table width="70%" border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<tr align="center">
	<td colspan="2"><a href="TestMethodServlet?flag=${testmethod}"><input type="button" name="goback" value="返回继续实验"/></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
