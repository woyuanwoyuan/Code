...
<div class="me col-md-7 header-left" id="me">
		
					<h3 class="w3l_head">个人风采</h3>
			<p class="w3ls_head_para">A few words about me</p>
			<!-- 按钮触发模态框 -->
                                            		<div class="input-group-btn pull-right">
<a class="btn  btn-default ${classinfo}"  data-toggle="modal" data-target="#myModal2" id="bianji" title="${title}" >
	编辑
</a>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   ...
   $.ajax({
	...
	<div class="about-grid3 w3layouts">
				...
				<div class="col-md-4 col-sm-4 about-grid about-info">
				...
				<div class="col-md-8 col-sm-8 about-grid about-image">
